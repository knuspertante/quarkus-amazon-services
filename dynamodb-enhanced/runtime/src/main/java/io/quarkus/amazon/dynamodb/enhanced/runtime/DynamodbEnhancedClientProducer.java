...
public class DynamodbEnhancedClientProducer {
    ...
    public void setDynamoDbClient(DynamoDbClient client, List<DynamoDbEnhancedClientExtension> extensionList) {
        syncEnhancedClient = DynamoDbEnhancedClient.builder().dynamoDbClient(client).extensions(extensionList).build();
    }

    public void setDynamoDbAsyncClient(DynamoDbAsyncClient client, List<DynamoDbEnhancedClientExtension> extensionList) {
