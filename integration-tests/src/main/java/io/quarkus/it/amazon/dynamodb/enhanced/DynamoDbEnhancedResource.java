...
public class DynamoDbEnhancedResource {
    ...
    private final static String EXTENSION_TABLE = "enhancedextension";
    ...
    public String testBlockingDynamoExtension() {
        ...
        DynamoDbTable<DynamoDBExampleTableEntry> exampleBlockingTable = dynamoEnhancedClient.table(EXTENSION_TABLE,
                TableSchema.fromClass(DynamoDBExampleTableEntry.class));
        ...
        // assert that AutoGeneratedTimestampRecordExtension set the timestamp
